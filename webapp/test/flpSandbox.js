					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Affichage Bureau Ordre",
									"targetURL": "#AffichageBureauOrdre-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"AffichageBureauOrdre-display": {
								"semanticObject": "AffichageBureauOrdre",
								"action": "display",
								"description": "Affichage des documents entrants",
								"title": "Affichage Bureau Ordre",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.aymax.apave.sd.BureauOrdre.BureauOrdreDisplay",
									"url": sap.ui.require.toUrl("com/aymax/apave/sd/BureauOrdre/BureauOrdreDisplay")
								}
							}
						}
					}
