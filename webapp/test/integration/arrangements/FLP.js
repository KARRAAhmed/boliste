...
sap.ui.define([
	...
	"com/aymax/apave/sd/BureauOrdre/BureauOrdreDisplay/test/flpSandbox"
	...
	return Opa5.extend("com.aymax.apave.sd.BureauOrdre.BureauOrdreDisplay.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "CATEGORYSet/" + encodeURIComponent(sObjectId);
