sap.ui.define([
	"sap/ui/test/Opa5",
	"com/aymax/apave/sd/BureauOrdre/BureauOrdreDisplay/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.aymax.apave.sd.BureauOrdre.BureauOrdreDisplay.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.aymax.apave.sd.BureauOrdre.BureauOrdreDisplay",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "CATEGORYSet/" + sObjectId;
